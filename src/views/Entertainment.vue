  ...
  <div class="news-app-wrapper bg-light-subtle min-vh-100">
    <div class="container py-5 font-khmer">
      ...
      <div class="d-flex justify-content-between align-items-end mb-5 pb-4">
        <div>
          <h2 class="fw-bold text-dark mb-1 ps-3">ព័ត៌មានកម្សាន្ត</h2>
          <p class="text-muted mb-0 ps-3">អានព្រឹត្តិការណ៍សិល្បៈ និងកម្សាន្តថ្មីៗបំផុតពីក្នុងប្រទេសកម្ពុជា</p>
        </div>
      </div>

      <div v-if="entertainmentList.length > 0" class="row g-4">
